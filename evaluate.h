...
#define KNIGHT_OUTPOST_BONUS_EARLY   16
#define KNIGHT_OUTPOST_BONUS_LATE     8
#define KNIGHT_ON_RIM_PENALTY         8
#define KNIGHT_MOBILITY_BONUS_EARLY   5
#define KNIGHT_MOBILITY_BONUS_LATE    3

#define BISHOP_DOUBLE_BONUS_EARLY     4
#define BISHOP_DOUBLE_BONUS_LATE      7
#define BISHOP_OPPOSITE_COLOR_BONUS_EARLY  6
#define BISHOP_OPPOSITE_COLOR_BONUS_LATE  12
#define BISHOP_PAIRITY_PENALTY       10
#define BISHOP_OPEN_GAME_BONUS        8
#define BISHOP_MOBILITY_BONUS_EARLY   5
#define BISHOP_MOBILITY_BONUS_LATE    3

#define ROOK_SEMI_OPEN_FILE_BONUS_EARLY   8
#define ROOK_SEMI_OPEN_FILE_BONUS_LATE   13
#define ROOK_OPEN_FILE_BONUS_EARLY   12
#define ROOK_OPEN_FILE_BONUS_LATE    20
#define ROOK_ON_SEVENTH_BONUS_EARLY  18
#define ROOK_ON_SEVENTH_BONUS_LATE   28
#define ROOK_BEHIND_PASSED_BONUS     14
#define ROOK_OPEN_FILE_VS_KING_BONUS 12
#define ROOK_MOBILITY_BONUS_EARLY     4
#define ROOK_MOBILITY_BONUS_LATE      6

#define QUEEN_MOBILITY_BONUS_EARLY    3
#define QUEEN_MOBILITY_BONUS_LATE     4
...
/* King safety: attack unit weights per piece type
   (indexed by piece enum: EMPTY=0,PAWN=1,BISHOP=2,KNIGHT=3,ROOK=4,QUEEN=5,KING=6) */
